    ...
    <div class="form-group">
        <div class="row">
            <div class="col-xs-6">
                ...
                <?php echo form_input(['name' => 'firstName', 'class' => 'form-control', 'value' => $user->getFirstName()]); ?>
            </div>

            <div class="col-xs-6">
                <label class="control-label">Last Name</label>
                <?php echo form_input(['name' => 'lastName', 'class' => 'form-control', 'value' => $user->getLastName()]); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
            ...
            <div class="col-xs-6">
                ...
                <?php
                    if ($user->getBirthDate() !== null) {
                        echo form_input(['name' => 'birthDate', 'class' => 'datepicker form-control', 'value' => $user->getBirthDate()->format('Y-m-d')]);
                    } else {
                        echo form_input(['name' => 'birthDate', 'class' => 'datepicker form-control']);
                    }
                ?>
            </div>
