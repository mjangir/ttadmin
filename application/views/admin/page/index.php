...
<div class="box box-primary">
    ...
    foreach ($data as $record) {
        ...
        ?>" class="ajax confirm" data-confirm-message="Are you sure, you want to delete this page" data-method="post" data-refresh=".paginated_tbl">
                                <i class="fa fa-trash-o text-danger" data-toggle="tooltip" title="Delete"></i></a>&nbsp;
                            <a href="<?php echo $statusUrl.'?id='.$id;
        ?>" class="ajax confirm" data-confirm-message="Are you sure, you want to make this page <?php echo $statusTitle;
