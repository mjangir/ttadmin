            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php echo form_textarea(array('name' => 'metaKeywords', 'class' => 'form-control', 'style' => 'height:50px'));?>
                    </div>
               </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php echo form_textarea(array('name' => 'metaDescription', 'class' => 'form-control', 'style' => 'height:80px'));?>
                    </div>
               </div>
            </div>
      </div>
