	...
	<div class="form-group">
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <?php echo form_dropdown('parentId', array('' => 'Select Link') + $linkDropdown, $link->getParentId(), 'class="form-control"');?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-6">
                ...
                <?php echo form_input(array('name' => 'name', 'class' => 'form-control', 'value' => $link->getName()));?>
            </div>

            <div class="col-xs-6">
                <label class="control-label">Alias Name</label>
                <?php echo form_input(array('name' => 'alias', 'class' => 'form-control', 'value' => $link->getAlias()));?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-6">
                ...
                <?php echo form_input(array('name' => 'icon', 'class' => 'form-control', 'value' => $link->getIcon()));?>
            </div>

            <div class="col-xs-6">
                <label class="control-label">Hyperlink</label>
                <?php echo form_input(array('name' => 'href', 'class' => 'form-control', 'value' => $link->getHref()));?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo form_input(array('name' => 'actions', 'class' => 'form-control', 'value' => $link->getActions()));?>
            </div>
        </div>
    </div>
</div>
