	...
	<div class="form-group">
        <div class="row category-wise-link">
            ...
            <div class="col-xs-6">
                ...
                <?php echo form_dropdown('parentId', ['' => 'Select Link'] + $linkDropdown, '', 'class="form-control link"'); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-xs-6">
                ...
                <?php echo form_input(['name' => 'icon', 'class' => 'form-control']); ?>
            </div>

            <div class="col-xs-6">
                <label class="control-label">Hyperlink</label>
                <?php echo form_input(['name' => 'href', 'class' => 'form-control']); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo form_input(['name' => 'actions', 'class' => 'form-control']); ?>
            </div>
        </div>
    </div>
</div>
