            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php echo form_input(['name' => 'default_available_bids', 'type' => 'number', 'min' => '1', 'class' => 'form-control', 'value' => $jackpot->getDefaultAvailableBids()]); ?>
                    </div>
               </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php echo form_input(['name' => 'increase_seconds_on_bid', 'type' => 'number', 'min' => '1', 'class' => 'form-control', 'value' => $jackpot->getIncreaseSecondsOnBid()]); ?>
                    </div>
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        ...
                        <?php echo form_input(['type' => 'text', 'name' => 'increase_amount', 'class' => 'form-control', 'value' => $jackpot->getIncreaseAmount()]); ?>
                    </div>
               </div>
            </div>
