	...
	<div class="form-group">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo form_input(array('name' => 'groupName', 'class' => 'form-control', 'value' => $userGroup->getGroupName()));?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <?php echo form_input(array('name' => 'alias', 'class' => 'form-control', 'value' => $userGroup->getAlias()));?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo form_textarea(array('name' => 'description', 'class' => 'form-control', 'rows' => '3', 'value' => $userGroup->getDescription()));?>
            </div>
        </div>
    </div>
</div>
