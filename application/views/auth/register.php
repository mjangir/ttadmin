<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        ?>
                <a href="<?php echo base_url('auth/social/Facebook'); ?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign Up using Facebook</a>
            <?php
    } ?>
            <?php if (isset($settings['google_login_enabled']) && $settings['google_login_enabled'] == 1) {
        ?>
                <a href="<?php echo base_url('auth/social/Google'); ?>" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google"></i> Sign Up using Google</a>
            <?php
    } ?>
            <?php if (isset($settings['twitter_login_enabled']) && $settings['twitter_login_enabled'] == 1) {
        ?>
                <a href="<?php echo base_url('auth/social/Twitter'); ?>" class="btn btn-block btn-social btn-twitter btn-flat"><i class="fa fa-twitter"></i> Sign Up using Twitter</a>
            <?php
    } ?>
            <?php if (isset($settings['linkedin_login_enabled']) && $settings['linkedin_login_enabled'] == 1) {
        ?>
                <a href="<?php echo base_url('auth/social/LinkedIn'); ?>" class="btn btn-block btn-social btn-linkedin btn-flat"><i class="fa fa-linkedin"></i> Sign Up using Linkedin</a>
            <?php
    } ?>
        </div>
