 ...
 */
class __CG__EntityCountry extends \Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', ''."\0".'Entity\\Country'."\0".'id', ''."\0".'Entity\\Country'."\0".'countryName', ''."\0".'Entity\\Country'."\0".'countryCode'];
        }
