...
class User
{
     ...
     * @var string
     *
     * @ORM\Column(name="facebook_id", type="string", length=30, nullable=true)
     */
    private $facebookId;
     ...
     * @var string
     *
     * @ORM\Column(name="forgot_pwd_salt", type="string", length=255, nullable=true)
     */
    private $forgotPwdSalt;
    ...
    {
        $this->forgotPwdSalt = $forgotPwdSalt;
